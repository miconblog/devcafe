...
var Component = React.createFactory(require('./components/UserList.jsx'));
...
},{"./components/UserList.jsx":2,"react":158}],2:[function(require,module,exports){
"use strict";
...
var UserList = React.createClass({ displayName: "UserList",
  ...
  render: function render() {
    ...
    return React.createElement("div", null, React.createElement("h4", null, "User List"), this.props.users.map(function (user, i) {
      return React.createElement("div", { key: user.id }, user.id, " ", user.name, " ", user.email, " ");
    }));
  }
